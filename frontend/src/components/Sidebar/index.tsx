...
import { FiCreditCard, FiPackage, FiShare2 } from 'react-icons/fi';
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Products --> */}
              <SidebarLinkGroup activeCondition={pathname.startsWith('/products')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          {[
                            ...
                            ['/products/subcategories', 'Subcategorias'],
              ...
              {/* <!-- Menu Item Global Catalogs --> */}
              <SidebarLinkGroup activeCondition={pathname.startsWith('/settings')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          {[
                            ...
                            ['/settings/payment-terms', 'Términos de Pago'],
              ...
              {/* <!-- Menu Item Relations --> */}
              <SidebarLinkGroup activeCondition={pathname.startsWith('/relations')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          {[
                            ['/relations/suppliers', 'Proveedores'],
                            ['/relations/warehouses', 'Almacenes'],
                            ['/relations/branches', 'Tiendas / Sucursales'],
                            ['/relations/company', 'Empresa'],
                          ].map(([to, label]) => (
                            <li key={to}>
                              <NavLink
                                to={to}
