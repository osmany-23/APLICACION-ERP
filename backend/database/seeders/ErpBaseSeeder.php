...
class ErpBaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $currencyId = DB::table('currencies')->updateOrInsert([
            'code' => 'NIO',
        ], [
            'name' => 'Córdoba',
            'symbol' => 'C$',
        ...
        if (Schema::hasTable('branches')) {
            $branchId = DB::table('branches')->updateOrInsert([
                'company_id' => is_array($companyId) ? $companyId['id'] : $companyId,
                'code' => 'SUC-CENTRAL',
            ], [
                'uuid' => Str::uuid(),
        ...
        if (Schema::hasTable('warehouses') && isset($branchId)) {
            DB::table('warehouses')->updateOrInsert([
                ...
                'branch_id' => is_array($branchId) ? $branchId['id'] : $branchId,
                'name' => 'Bodega Central',
                'type' => 'PRINCIPAL',
                'status' => 1,
                'updated_at' => now(),
